...
public static class SaveFileTypeExtensions
{
    ...
    public static SaveFileType GetSaveFileType(this GameVersion version) => version switch
    {
        ...
        GameVersion.RD or GameVersion.GN or GameVersion.YW or GameVersion.BU or GameVersion.RBY => RBY,
        GameVersion.GD or GameVersion.SI or GameVersion.C or GameVersion.GS or GameVersion.GSC => GSC,
        ...
        GameVersion.AS or GameVersion.OR or GameVersion.ORAS => AO,
        GameVersion.SN or GameVersion.MN or GameVersion.SM => SM,
        GameVersion.US or GameVersion.UM or GameVersion.USUM => USUM,
        GameVersion.GP or GameVersion.GE or GameVersion.GG => LGPE,
