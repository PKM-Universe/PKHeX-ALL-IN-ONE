...
internal static class Encounters9a
{
    ...
    [
        ...
        new(0150,0,85,255) { Location = 00240, Nature = Nature.Timid, FlawlessIVCount = 6, Shiny = Random, IsAlpha = true, Moves = new(094,540,417,059), ScaleType = 0, ScaleValue = 255 }, // Mewtwo (project_m_mewtwo) - Perfect IVs, Alpha, Psychic/Psystrike/Will-O-Wisp/Blizzard
